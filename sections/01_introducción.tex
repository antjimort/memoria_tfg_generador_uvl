...
\begin{enumerate}[label=\textbf{O\arabic*.}]
      ...
      \item Evaluar el comportamiento del generador bajo escenarios de generación con un volumen elevado de modelos, analizando el coste asociado a la inicialización del entorno y al proceso de generación.
...
\begin{longtable}{@{}P{1cm} P{6.2cm} P{4.6cm} P{1.7cm}@{}}
  ...
  O3 & La solución desarrollada queda integrada dentro del ecosistema Flamapy y puede ser utilizada desde UVLHub como herramienta de generación de modelos. & Verificación de la integración del plugin en Flamapy y comprobación del flujo completo de generación desde UVLHub. & 6, 7 \\[0.3em]
